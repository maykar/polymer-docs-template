...
Mr({_template:Wr`
    ...
    <slot></slot>
`,is:"paper-item",behaviors:[[No,bo,{hostAttributes:{role:"option",tabindex:"0"}}]]});var Qo="Documentation Demo Site",Go="intro",Xo="https://github.com/maykar/polymer-docs-template",es="master",ts=[{category:"intro",icon:"icons:home"},{category:"installation",icon:"icons:arrow-downward"},{category:"configuration",icon:"icons:create"}],ns=[{category:"faq",icon:"icons:help"}],is=[{link:"https://github.com/maykar/polymer-docs-template",caption:"GitHub"},{link:"https://github.com/maykar/polymer-docs-template/issues",caption:"Issues"}];const rs=ce`
  app-header {
...
</custom-style>`;as.setAttribute("style","display: none;"),document.head.appendChild(as.content);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
</dom-module>`;ls.setAttribute("style","display: none;"),document.head.appendChild(ls.content),
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const hl=new WeakMap,dl=(e=>(...n)=>{const i=e(...n);return t.set(i,!0),i})(e=>t=>{if(!(t instanceof z))throw new Error("unsafeHTML can only be used in text bindings");const n=hl.get(t);if(void 0!==n&&_(e)&&e===n.value&&t.value===n.fragment)return;const i=document.createElement("template");i.innerHTML=e;const r=document.importNode(i.content,!0);t.setValue(r),hl.set(t,{value:e,fragment:r})}),pl=ce`
  /*
...
`];cl.registerLanguage("yaml",(function(e){var t={className:"string",relevance:0,variants:[{begin:/'/,end:/'/},{begin:/"/,end:/"/},{begin:/\S+/}],contains:[e.BACKSLASH_ESCAPE,{className:"template-variable",variants:[{begin:"{{",end:"}}"},{begin:"%{",end:"}"}]}]};return{case_insensitive:!0,aliases:["yml","YAML","yaml"],contains:[{className:"attr",variants:[{begin:"\\w[\\w :\\/.-]*:(?=[ \t]|$)"},{begin:'"\\w[\\w :\\/.-]*":(?=[ \t]|$)'},{begin:"'\\w[\\w :\\/.-]*':(?=[ \t]|$)"}]},{className:"meta",begin:"^---s*$",relevance:10},{className:"string",begin:"[\\|>]([0-9]?[+-])?[ ]*\\n( *)[\\S ]+\\n(\\2[\\S ]+\\n?)*"},{begin:"<%[%=-]?",end:"[%-]?%>",subLanguage:"ruby",excludeBegin:!0,excludeEnd:!0,relevance:0},{className:"type",begin:"!"+e.UNDERSCORE_IDENT_RE},{className:"type",begin:"!!"+e.UNDERSCORE_IDENT_RE},{className:"meta",begin:"&"+e.UNDERSCORE_IDENT_RE+"$"},{className:"meta",begin:"\\*"+e.UNDERSCORE_IDENT_RE+"$"},{className:"bullet",begin:"\\-(?=[ ]|$)",relevance:0},e.HASH_COMMENT_MODE,{beginKeywords:"true false yes no null",keywords:{literal:"true false yes no null"}},{className:"number",begin:e.C_NUMBER_RE+"\\b"},t]}}));const fl=cl,gl=ps;gl.setOptions({highlight:function(e,t){return t&&fl.getLanguage(t)?fl.highlight(t,e,!0).value:fl.highlightAuto(e).value},breaks:!0,gfm:!0,tables:!0,langPrefix:""});class ml{static html(e,t={}){if(e.includes("---\n")){var n=e.split("---\n");e=n.slice(2).join("---\n")}return e=e.replace(/\:\S+:/,""),P`
      <style>
        ${ul} ${pl}
      </style>
    ...
    `}static settings(e){var t={};return e.includes("---\n")&&3===e.split("---\n").length&&(t=ll.parse(e.split("---\n")[1])),t}}let vl=class extends de{render(){const e=ml.html(this.content.content_html);return P`
      <paper-card>
    ...
    `}};e([oe()],vl.prototype,"content",void 0),vl=e([ne("docs-card")],vl);
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
`,is:"iron-a11y-announcer",properties:{mode:{type:String,value:"polite"},_text:{type:String,value:""}},created:function(){yl.instance||(yl.instance=this),document.body.addEventListener("iron-announce",this._onIronAnnounce.bind(this))},announce:function(e){this._text="",this.async((function(){this._text=e}),100)},_onIronAnnounce:function(e){e.detail&&e.detail.text&&this.announce(e.detail.text)}});yl.instance=null,yl.requestAvailability=function(){yl.instance||(yl.instance=document.createElement("iron-a11y-announcer")),document.body.appendChild(yl.instance)};
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
found at http://polymer.github.io/PATENTS.txt
*/
let _l=null;const bl={properties:{validator:{type:String},invalid:{notify:!0,reflectToAttribute:!0,type:Boolean,value:!1,observer:"_invalidChanged"}},registered:function(){_l=new mo({type:"validator"})},_invalidChanged:function(){this.invalid?this.setAttribute("aria-invalid","true"):this.removeAttribute("aria-invalid")},get _validator(){return _l&&_l.byKey(this.validator)},hasValidator:function(){return null!=this._validator},validate:function(e){return void 0===e&&void 0!==this.value?this.invalid=!this._getValidity(this.value):this.invalid=!this._getValidity(e),!this.invalid},_getValidity:function(e){return!this.hasValidator()||this._validator.validate(e)}};
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
found at http://polymer.github.io/PATENTS.txt
*/
const wl={attached:function(){this.fire("addon-attached")},update:function(e){}};
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
`,is:"paper-input-char-counter",behaviors:[wl],properties:{_charCounterStr:{type:String,value:"0"}},update:function(e){if(e.inputElement){e.value=e.value||"";var t=e.value.toString().length.toString();e.inputElement.hasAttribute("maxlength")&&(t+="/"+e.inputElement.getAttribute("maxlength")),this._charCounterStr=t}}});
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
`;xl.setAttribute("style","display: none;"),document.head.appendChild(xl.content),Mr({_template:Wr`
    <style>
      :host {
        display: block;
        padding: 8px 0;
...
`,is:"paper-input-error",behaviors:[wl],properties:{invalid:{readOnly:!0,reflectToAttribute:!0,type:Boolean}},update:function(e){this._setInvalid(e.invalid)}});
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
Mr({is:"paper-input",_template:Wr`
  ...
  `,behaviors:[[bo,Ho,Sl],zl],properties:{value:{type:String}},get _focusableElement(){return this.inputElement._inputElement},listeners:{"iron-input-ready":"_onIronInputReady"},_onIronInputReady:function(){this.$.nativeInput||(this.$.nativeInput=this.$$("input")),this.inputElement&&-1!==this._typesThatHaveText.indexOf(this.$.nativeInput.type)&&(this.alwaysFloatLabel=!0),this.inputElement.bindValue&&this.$.container._handleValueAndAutoValidate(this.inputElement)}});
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
part of the polymer project is also subject to an additional IP rights grant
found at http://polymer.github.io/PATENTS.txt
*/var Al=Element.prototype,Ml=Al.matches||Al.matchesSelector||Al.mozMatchesSelector||Al.msMatchesSelector||Al.oMatchesSelector||Al.webkitMatchesSelector;const El={getTabbableNodes:function(e){var t=[];return this._collectTabbableNodes(e,t)?this._sortByTabIndex(t):t},isFocusable:function(e){return Ml.call(e,"input, select, textarea, button, object")?Ml.call(e,":not([disabled])"):Ml.call(e,"a[href], area[href], iframe, [tabindex], [contentEditable]")},isTabbable:function(e){return this.isFocusable(e)&&Ml.call(e,':not([tabindex="-1"])')&&this._isVisible(e)},_normalizedTabIndex:function(e){if(this.isFocusable(e)){var t=e.getAttribute("tabindex")||0;return Number(t)}return-1},_collectTabbableNodes:function(e,t){if(e.nodeType!==Node.ELEMENT_NODE||!this._isVisible(e))return!1;var n,i=e,r=this._normalizedTabIndex(i),o=r>0;r>=0&&t.push(i),n="content"===i.localName||"slot"===i.localName?xr(i).getDistributedNodes():xr(i.root||i).children;for(var s=0;s<n.length;s++)o=this._collectTabbableNodes(n[s],t)||o;return o},_isVisible:function(e){var t=e.style;return"hidden"!==t.visibility&&"none"!==t.display&&("hidden"!==(t=window.getComputedStyle(e)).visibility&&"none"!==t.display)},_sortByTabIndex:function(e){var t=e.length;if(t<2)return e;var n=Math.ceil(t/2),i=this._sortByTabIndex(e.slice(0,n)),r=this._sortByTabIndex(e.slice(n));return this._mergeSortByTabIndex(i,r)},_mergeSortByTabIndex:function(e,t){for(var n=[];e.length>0&&t.length>0;)this._hasLowerTabOrder(e[0],t[0])?n.push(t.shift()):n.push(e.shift());return n.concat(e,t)},_hasLowerTabOrder:function(e,t){var n=Math.max(e.tabIndex,0),i=Math.max(t.tabIndex,0);return 0===n||0===i?i>n:n>i}};
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
part of the polymer project is also subject to an additional IP rights grant
found at http://polymer.github.io/PATENTS.txt
*/var Ol,Hl,Pl={pageX:0,pageY:0},Nl=null,Il=[],Vl=["wheel","mousewheel","DOMMouseScroll","touchstart","touchmove"];function Rl(e){Dl.indexOf(e)>=0||(0===Dl.length&&function(){Ol=Ol||$l.bind(void 0);for(var e=0,t=Vl.length;e<t;e++)document.addEventListener(Vl[e],Ol,{capture:!0,passive:!1})}(),Dl.push(e),Hl=Dl[Dl.length-1])}function Bl(e){var t=Dl.indexOf(e);-1!==t&&(Dl.splice(t,1),Hl=Dl[Dl.length-1],0===Dl.length&&function(){for(var e=0,t=Vl.length;e<t;e++)document.removeEventListener(Vl[e],Ol,{capture:!0,passive:!1})}())}const Dl=[];function $l(e){if(e.cancelable&&function(e){var t=xr(e).rootTarget;"touchmove"!==e.type&&Nl!==t&&(Nl=t,Il=function(e){for(var t=[],n=e.indexOf(Hl),i=0;i<=n;i++)if(e[i].nodeType===Node.ELEMENT_NODE){var r=e[i],o=r.style;"scroll"!==o.overflow&&"auto"!==o.overflow&&(o=window.getComputedStyle(r)),"scroll"!==o.overflow&&"auto"!==o.overflow||t.push(r)}return t}(xr(e).path));if(!Il.length)return!0;if("touchstart"===e.type)return!1;var n=function(e){var t={deltaX:e.deltaX,deltaY:e.deltaY};if("deltaX"in e);else if("wheelDeltaX"in e&&"wheelDeltaY"in e)t.deltaX=-e.wheelDeltaX,t.deltaY=-e.wheelDeltaY;else if("wheelDelta"in e)t.deltaX=0,t.deltaY=-e.wheelDelta;else if("axis"in e)t.deltaX=1===e.axis?e.detail:0,t.deltaY=2===e.axis?e.detail:0;else if(e.targetTouches){var n=e.targetTouches[0];t.deltaX=Pl.pageX-n.pageX,t.deltaY=Pl.pageY-n.pageY}return t}
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
part of the polymer project is also subject to an additional IP rights grant
found at http://polymer.github.io/PATENTS.txt
*/Mr({is:"fade-in-animation",behaviors:[jl],configure:function(e){var t=e.node;return this._effect=new KeyframeEffect(t,[{opacity:"0"},{opacity:"1"}],this.timingFromConfig(e)),this._effect}}),
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
found at http://polymer.github.io/PATENTS.txt
*/
Mr({is:"fade-out-animation",behaviors:[jl],configure:function(e){var t=e.node;return this._effect=new KeyframeEffect(t,[{opacity:"1"},{opacity:"0"}],this.timingFromConfig(e)),this._effect}}),
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
found at http://polymer.github.io/PATENTS.txt
*/
var Ul={ANIMATION_CUBIC_BEZIER:"cubic-bezier(.3,.95,.5,1)",MAX_ANIMATION_TIME_MS:400};const Yl=Mr({_template:Wr`
    <style>
      :host {
        display: inline-block;
        position: relative;
...
`,is:"paper-menu-button",behaviors:[Ho,bo],properties:{opened:{type:Boolean,value:!1,notify:!0,observer:"_openedChanged"},horizontalAlign:{type:String,value:"left",reflectToAttribute:!0},verticalAlign:{type:String,value:"top",reflectToAttribute:!0},dynamicAlign:{type:Boolean},horizontalOffset:{type:Number,value:0,notify:!0},verticalOffset:{type:Number,value:0,notify:!0},noOverlap:{type:Boolean},noAnimations:{type:Boolean,value:!1},ignoreSelect:{type:Boolean,value:!1},closeOnActivate:{type:Boolean,value:!1},openAnimationConfig:{type:Object,value:function(){return[{name:"fade-in-animation",timing:{delay:100,duration:200}},{name:"paper-menu-grow-width-animation",timing:{delay:100,duration:150,easing:Ul.ANIMATION_CUBIC_BEZIER}},{name:"paper-menu-grow-height-animation",timing:{delay:100,duration:275,easing:Ul.ANIMATION_CUBIC_BEZIER}}]}},closeAnimationConfig:{type:Object,value:function(){return[{name:"fade-out-animation",timing:{duration:150}},{name:"paper-menu-shrink-width-animation",timing:{delay:100,duration:50,easing:Ul.ANIMATION_CUBIC_BEZIER}},{name:"paper-menu-shrink-height-animation",timing:{duration:200,easing:"ease-in"}}]}},allowOutsideScroll:{type:Boolean,value:!1},restoreFocusOnClose:{type:Boolean,value:!0},_dropdownContent:{type:Object}},hostAttributes:{role:"group","aria-haspopup":"true"},listeners:{"iron-activate":"_onIronActivate","iron-select":"_onIronSelect"},get contentElement(){for(var e=xr(this.$.content).getDistributedNodes(),t=0,n=e.length;t<n;t++)if(e[t].nodeType===Node.ELEMENT_NODE)return e[t]},toggle:function(){this.opened?this.close():this.open()},open:function(){this.disabled||this.$.dropdown.open()},close:function(){this.$.dropdown.close()},_onIronSelect:function(e){this.ignoreSelect||this.close()},_onIronActivate:function(e){this.closeOnActivate&&this.close()},_openedChanged:function(e,t){e?(this._dropdownContent=this.contentElement,this.fire("paper-dropdown-open")):null!=t&&this.fire("paper-dropdown-close")},_disabledChanged:function(e){bo._disabledChanged.apply(this,arguments),e&&this.opened&&this.close()},__onIronOverlayCanceled:function(e){var t=e.detail,n=this.$.trigger;xr(t).path.indexOf(n)>-1&&e.preventDefault()}});Object.keys(Ul).forEach((function(e){Yl[e]=Ul[e]}));
/**
@license
Copyright (c) 2016 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
found at http://polymer.github.io/PATENTS.txt
*/
const Kl=document.createElement("template");Kl.setAttribute("style","display: none;"),Kl.innerHTML='<iron-iconset-svg name="paper-dropdown-menu" size="24">\n<svg><defs>\n<g id="arrow-drop-down"><path d="M7 10l5 5 5-5z"></path></g>\n</defs></svg>\n</iron-iconset-svg>',document.head.appendChild(Kl.content);
/**
@license
Copyright (c) 2016 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
found at http://polymer.github.io/PATENTS.txt
*/
const ql=document.createElement("template");ql.setAttribute("style","display: none;"),ql.innerHTML='<dom-module id="paper-dropdown-menu-shared-styles">\n  <template>\n    <style>\n      :host {\n        display: inline-block;\n        position: relative;\n        text-align: left;\n\n        /* NOTE(cdata): Both values are needed, since some phones require the\n         * value to be `transparent`.\n         */\n        -webkit-tap-highlight-color: rgba(0,0,0,0);\n        -webkit-tap-highlight-color: transparent;\n\n        --paper-input-container-input: {\n          overflow: hidden;\n          white-space: nowrap;\n          text-overflow: ellipsis;\n          max-width: 100%;\n          box-sizing: border-box;\n          cursor: pointer;\n        };\n\n        @apply --paper-dropdown-menu;\n      }\n\n      :host([disabled]) {\n        @apply --paper-dropdown-menu-disabled;\n      }\n\n      :host([noink]) paper-ripple {\n        display: none;\n      }\n\n      :host([no-label-float]) paper-ripple {\n        top: 8px;\n      }\n\n      paper-ripple {\n        top: 12px;\n        left: 0px;\n        bottom: 8px;\n        right: 0px;\n\n        @apply --paper-dropdown-menu-ripple;\n      }\n\n      paper-menu-button {\n        display: block;\n        padding: 0;\n\n        @apply --paper-dropdown-menu-button;\n      }\n\n      paper-input {\n        @apply --paper-dropdown-menu-input;\n      }\n\n      iron-icon {\n        color: var(--disabled-text-color);\n\n        @apply --paper-dropdown-menu-icon;\n      }\n    </style>\n  </template>\n</dom-module>',document.head.appendChild(ql.content),
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
Mr({_template:Wr`
    ...
    <slot></slot>
`,is:"paper-listbox",behaviors:[Wo],hostAttributes:{role:"listbox"}});let Wl=class extends de{render(){return P`
      <paper-menu-button
        no-animations
    ...
    `}editOnGithub(){window.open(`${Xo}/edit/${es}/docs/${this.category}/${this.page}.md`,"_blank")}static get styles(){return[ce`
        paper-menu-button {
          float: right;
        }
      ...
      `]}};e([oe()],Wl.prototype,"category",void 0),e([oe()],Wl.prototype,"page",void 0),Wl=e([ne("docs-dot-menu")],Wl);let Jl=class extends de{constructor(){super(...arguments),this.search=!1,this.searchterm=""}render(){return P`
    ...
    `)}static get styles(){return ss}};e([oe()],Zl.prototype,"docs",void 0),e([oe()],Zl.prototype,"page",void 0),e([oe()],Zl.prototype,"category",void 0),e([oe()],Zl.prototype,"expanded",void 0),e([oe()],Zl.prototype,"tabs",void 0),Zl=e([ne("docs-main")],Zl);export{Zl as Main};
