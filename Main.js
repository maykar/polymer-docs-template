...
part of the polymer project is also subject to an additional IP rights grant
found at http://polymer.github.io/PATENTS.txt
*/Mr({is:"fade-in-animation",behaviors:[$l],configure:function(e){var t=e.node;return this._effect=new KeyframeEffect(t,[{opacity:"0"},{opacity:"1"}],this.timingFromConfig(e)),this._effect}}),
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
found at http://polymer.github.io/PATENTS.txt
*/
Mr({is:"fade-out-animation",behaviors:[$l],configure:function(e){var t=e.node;return this._effect=new KeyframeEffect(t,[{opacity:"1"},{opacity:"0"}],this.timingFromConfig(e)),this._effect}}),
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
`,is:"paper-listbox",behaviors:[Wo],hostAttributes:{role:"listbox"}});let ql=class extends de{render(){return P`
    ...
    `)}static get styles(){return os}};e([oe()],Jl.prototype,"docs",void 0),e([oe()],Jl.prototype,"page",void 0),e([oe()],Jl.prototype,"category",void 0),e([oe()],Jl.prototype,"expanded",void 0),Jl=e([ne("docs-main")],Jl);export{Jl as Main};
