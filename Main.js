...
`,is:"paper-listbox",behaviors:[Wo],hostAttributes:{role:"listbox"}});let ql=class extends de{render(){return P`
    ...
    `}editOnGithub(){window.open(`${Xo}/edit/master/docs/${this.category}/${this.page}.md`,"_blank")}static get styles(){return[ce`
      ...
      ${this.searchterm.length?P`
          ...
          `:""}
    `}firstUpdated(){const e=e=>{for(const t of e.path){if("DOCS-SEARCH"===t.nodeName)return;t.nodeName}this.search=!1};document.addEventListener("click",function(t){e(t)}.bind(this))}updated(){this.search||(this.searchterm="")}toggleSearch(){this.search=!this.search}searchClick(e){window.open(e.composedPath()[0].href,"_self"),window.location.reload()}Search(e){this.searchterm=e.composedPath()[0].value}static get styles(){return[os,ce`
        .result-item {
          cursor: pointer;
          text-decoration: none;
